    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
                    <h1 className="text-3xl font-bold mb-4">Aaraf Sports</h1>
                    <img className="w-full mb-4" src="https://i.ibb.co.com/7r3H2vS/download-13.jpg" alt='Tutor Home' />
                    ...
                    <p className="mb-4">
                        <a href="https://aaraf-sports.web.app/" className="text-blue-500 hover:underline">
                        https://aaraf-sports.web.app/
                        </a>
                    </p>
                    <h2 className="text-2xl font-semibold mb-2">GitHub Repository Link (Client-Side)</h2>
                    <p className="mb-4">
                        <a href='https://github.com/Anamul-Hoque37/aaraf-sports-1' className="text-blue-500 hover:underline">
                        https://github.com/Anamul-Hoque37/aaraf-sports-1
                        </a>
                    </p>
